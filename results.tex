...
\includegraphics[width=12cm]{images/mesh1-r.pdf}
\caption{2D mesh, the red square is zoomed in the fig. \ref{fig:mesh2d2}}\label{fig:mesh2d}
\end{figure}

\begin{figure}[htp]
\centering
\includegraphics[width=12cm]{images/mesh4.png}
\caption{Zoomed in 2D mesh}\label{fig:mesh2d2}
\end{figure}
