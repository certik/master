...
caused either by a different radial grid (we used a hyperbolic grid with 10000
points), or by a different implementation of the exchange and correlation
potential approximation (both our code and NIST uses the potential proposed by
MacDonald and Vosko). In particular, we implemented the equation (\ref{RLDA}),
see also the discussion leading to it.
