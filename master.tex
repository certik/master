...
\usepackage[latin2]{inputenc} % nastavuje použité kódování, uživatelé Windows zamění latin2 za cp1250
\usepackage{czech}
...
\large
\noindent Vedoucí bakalářské práce: Jméno se všemi tituly a pracoviště, % doplňte odpovídající údaje
...
\begin{center}
2006 % doplňte rok vzniku vaší bakalářské práce
\end{center}
